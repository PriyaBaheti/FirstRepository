...
justify-content:center;border:3px dashed darkblue;border-radius:8px;padding:1em;margin:2em auto;">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) { ?>
                <div class="card" style="width: 18rem;box-shadow:0 0 10px #cacaca;margin:2em;">
                    <img src="images/user.png" class="card-img-top" alt="error">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $row['uname'] ?></h5>
                        <p class="card-text">Some Info</p>
                        <a href="#" class="btn btn-primary"><?php echo $row['pass'] ?></a>
                    </div>
                </div>
